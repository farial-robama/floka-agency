...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    gsap.from(ctaRef.current, {
      ...
      delay: 0.8, ease: "power3.out",
    });
    // Image reveal
    gsap.from(imgRef.current, {
      clipPath: "inset(0 0 100% 0)",
      duration: 1.2, delay: 0.5, ease: "power4.out",
    });
    // Desc
    gsap.from(descRef.current, {
      y: 20, opacity: 0, duration: 0.8,
      delay: 1, ease: "power3.out",
    });
    ...
    const onScroll = () => {
      ...
      gsap.set(blob1Ref.current, { y: sy * 0.3 });
      gsap.set(blob2Ref.current, { y: sy * 0.2 });
    };
    ...
    >
        ...
        <div>
          <div
            style={{
              ...
              color: "#c8f542", marginBottom: "24px",
              display: "flex", alignItems: "center", gap: "12px",
            }}
          >
            <span style={{ display: "block", width: "32px", height: "1px", background: "#c8f542" }} />
            Studio
          </div>
          ...
          >
            ...
            <span style={{ display: "block", fontStyle: "italic", color: "#c8f542" }}>D. Nelsi</span>
          </div>
      ...
      >
        <div
          ...
          style={{ width: "1px", height: "60px", background: "linear-gradient(to bottom, #c8f542, transparent)" }}
        />
        <span style={{
          fontFamily: "'Syne', sans-serif", fontSize: "10px",
